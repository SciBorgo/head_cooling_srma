...
# Plot
png(file = 'figures/rpe.png', width = 6.5, height = 6, res = 600, units = "in") 
...
overall_results %>%
  write.csv(file = 'results/table_rpe.csv',
            row.names = F)
...
final_results %>%
  ...
  cols_align(align = "left") -> sens_table_rpe; sens_table_rpe

gtsave(sens_table_rpe, "sensitivity results/sensitivity_rpe.docx")
