...
# Plot
png(file = 'figures/core_temp.png', width = 7, height = 8, res = 600, units = "in") 
...
overall_results %>%
  write.csv(file = 'results/table_core_temp.csv',
            row.names = F)
...
final_results %>%
  ...
  cols_align(align = "left") -> sens_table_tcore; sens_table_tcore

gtsave(sens_table_tcore, "sensitivity results/sensitivity_tcore.docx")
