...
# Plot
png(file = 'figures/time_trial_perf.png', width = 6, height = 3, res = 600, units = "in") 
...
overall_results %>%
  write.csv(file = 'results/table_time_trial_perf.csv',
            row.names = F)
...
final_results %>%
  ...
  cols_align(align = "left") -> sens_table; sens_table

gtsave(sens_table, "sensitivity results/sensitivity_tt.docx")
