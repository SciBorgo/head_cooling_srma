...
# Plot
png(file = 'figures/thermal_comfort.png', width = 6, height = 4, res = 600, units = "in") 
...
overall_results %>%
  write.csv(file = 'results/table_thermal_comfort.csv',
            row.names = F)
...
final_results %>%
  ...
  cols_align(align = "left") -> sens_table_comfort; sens_table_comfort

gtsave(sens_table_comfort, "sensitivity results/sensitivity_comfort.docx")
