...
# Plot
png(file = 'figures/heart_rate.png', width = 7, height = 8, res = 600, units = "in") 
...
overall_results %>%
  write.csv(file = 'results/table_heart_rate.csv',
            row.names = F)
...
final_results %>%
  ...
  cols_align(align = "left") -> sens_table_hr; sens_table_hr

gtsave(sens_table_hr, "sensitivity results/sensitivity_hr.docx")
